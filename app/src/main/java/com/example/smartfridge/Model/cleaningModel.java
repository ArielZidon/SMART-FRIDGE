...
import com.example.smartfridge.local_customer_memory.cleaningCategoryActivity;
...
public class cleaningModel implements category {
    cleaningCategoryActivity activity;
    ArrayList<ModelClass> arrayList;

    public cleaningModel(cleaningCategoryActivity activity){
