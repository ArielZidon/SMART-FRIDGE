...
import com.example.smartfridge.local_customer_memory.*;

import java.lang.reflect.Type;
import java.util.ArrayList;

public class dryFoodModel implements category{
    dryFoodCategoryActivity activity;
    ArrayList<ModelClass> arrayList;

    public dryFoodModel(dryFoodCategoryActivity activity){
