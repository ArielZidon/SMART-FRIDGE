...
import com.example.smartfridge.Model.cleaningModel;
...
public class cleaningCategoryActivity extends AppCompatActivity {
    cleaningModel model = new cleaningModel(this);
    AlertDialog dialog;
    LinearLayout layout;
    EditText name;
    EditText number;
