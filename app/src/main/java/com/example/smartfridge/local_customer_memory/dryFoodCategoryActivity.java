...
import com.example.smartfridge.Model.dryFoodModel;
...
public class dryFoodCategoryActivity extends AppCompatActivity  {
    dryFoodModel model= new dryFoodModel(this);
    AlertDialog dialog;
    LinearLayout layout;
    EditText name;
    EditText number;
